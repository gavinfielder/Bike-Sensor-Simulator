...
%%
figure(54);clf;
plot(timeValues(2:tUpperBound-1),pitch(2:tUpperBound-1),'.r');
plot(timeValues(2:tUpperBound-1),yaw(2:tUpperBound-1),'.g');
plot(timeValues(2:tUpperBound-1),roll(2:tUpperBound-1),'.b');

%%
figure(44);clf;
plot(timeValues(2:tUpperBound-1),d_th(2:tUpperBound-1));
